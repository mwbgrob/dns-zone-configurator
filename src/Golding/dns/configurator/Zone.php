...
namespace Golding\dns\configurator;

use Golding\dns\configurator\deserializer\ArrayDeserializer;
use Golding\dns\configurator\deserializer\PlainDeserializer;
use Golding\dns\configurator\errors\ErrorsStore;
use Golding\dns\configurator\errors\ValidationError;
use Golding\dns\configurator\traits\RecordsIterateTrait;
use Golding\dns\configurator\validators\HostnameValidator;
 ...
 * Class Zone
 *
 * @package Golding\dns\configurator
 */
class Zone
{
