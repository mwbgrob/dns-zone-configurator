...
namespace Golding\dns\configurator\zoneEntities;

use Golding\dns\configurator\errors\ValidationError;
use Golding\dns\configurator\traits\RecordsIterateTrait;
use Golding\dns\configurator\validators\CnameNumberCheck;
use Golding\dns\configurator\validators\ConflictTypesValidator;
use Golding\dns\configurator\validators\DnsZoneDomainNameValidator;
use Golding\dns\configurator\validators\OutOfZoneDataValidator;
use Golding\dns\configurator\validators\SoaNumberCheck;
...
use Golding\dns\enums\eRecordNotification;
use Golding\dns\enums\eRecordType;

/**
 * Class Node
 *
 * @package Golding\dns\configurator\zoneEntities
 */
class Node
{
